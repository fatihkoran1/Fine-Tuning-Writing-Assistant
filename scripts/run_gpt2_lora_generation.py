...
def main():
    ...
    parser.add_argument(
        "--adapter_path",
        type=str,
        default="models/fine_tuned/gpt2_lora_512_chunked_500",
    )
    ...
    parser.add_argument(
        "--output_path",
        type=str,
        default="results/post_finetune_outputs_gpt2_512_chunked_500.csv",
    )
    ...
    print(f"Saved GPT-2 LoRA generation outputs to: {output_path}")
